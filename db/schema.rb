...
ActiveRecord::Schema[7.0].define(version: 20_220_707_095_532) do
  ...
  create_table 'topic_relations', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[follower_topic_id topic_added_id],
            name: 'index_topic_relations_on_follower_topic_id_and_topic_added_id', unique: true
